# Table definitions, mirroring snowflake/REFERRAL_TRIAGE/schema (1).sql and
# snowflake/OUTPUT_UI/Schema (2).sql. Primary keys are left out: Snowflake
...
locals {
  tables = {
    ...
    # Written by main.py (db.py store_result) after the AI classifies a referral.
    AI_REFERRAL_RESULTS = {
